...
from v5_final.s11_v2_item022_terminal_reconciliation_v1 import (
    DECISION,
    OUTPUT,
    S11V2Item022TerminalReconciliationError,
    _digest,
    _embedded_digest,
    _load,
    audit_frozen,
...
def test_capture_refuses_dirty_tree(monkeypatch, tmp_path: Path) -> None:
    from v5_final import s11_v2_item022_terminal_reconciliation_v1 as subject
    ...
    with pytest.raises(S11V2Item022TerminalReconciliationError, match="clean worktree"):
        subject.capture()
